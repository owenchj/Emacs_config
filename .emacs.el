...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((eval when (fboundp (quote aggressive-indent-mode)) (aggressive-indent-mode -1)) (eval when (fboundp (quote rainbow-mode)) (rainbow-mode 1))))))
(custom-set-faces
...
;; cohence between high level and sub-level
...
;; avoid the underscore to subscript
